  ...
  return (
    ...
    >
      <div className="left">
        ...
        <p>
          Hand Amitié est une association proposant une catéchèse spécialisée,
          c'est-à-dire s'adressant aux personnes avec un handicap mental.
        </p>
        <p>Nous nous adressons aux adultes entre 25 et 60 ans.</p>
        <p>
          Nous nous voyons avant tout comme un groupe de rencontre, certes un
          peu particulier à au moins deux égards :<br />
          nous accueillons des personnes avec un handicap, et nous nous
        ...
        <p>
          ...enfin, dans ce groupe, nous nous demandons encore qui accueille
          qui.
        </p>
        <p>
          Et si vous nous demandez qui accompagne qui sur le chemin du Christ,
